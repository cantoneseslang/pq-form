...
export async function clearDailyReportRow(tabName, targetRow) {
...
async function resolveDailyReportContext(payload) {
  ...
  return { tabName, targetRow, values, block, pageType, machine };
}
...
export async function deleteDailyReportEntry(payload) {
  ...
  return clearDailyReportRow(tabName, targetRow);
}
